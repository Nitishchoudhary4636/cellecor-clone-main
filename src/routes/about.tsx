...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Cellecor — Our story" },
    ...
    <SiteLayout>
      ...
      <section className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16 prose prose-neutral">
        <p className="text-lg text-muted-foreground">
          Cellecor started in 2018 with a simple idea — that great gadgets shouldn't cost a fortune and shouldn't look out of place in your home.
        </p>
